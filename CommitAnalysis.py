...
with open(COMMIT_HISTORY_FILE_PATH) as commitFile : 
        for line in commitFile:
                commitIdAndType, _ = line.split(":") #get the half part of the line that has commit id and type
                _,commitType,_ = commitIdAndType.split(" ") #splitting with the spaces gets you [commitid,commit type, blank space]
